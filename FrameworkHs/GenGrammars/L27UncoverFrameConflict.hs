...
instance PP Body where
  pp (Locals l l2 t) = (ppSexp [fromByteString "locals",(ppSexp (map pp l)),(ppSexp [fromByteString "frame-conflict",(ppSexp (map (\(u,l) -> (ppSexp ((pp u) : (map pp l)))) l2)),(pp t)])])
  ppp (Locals l l2 t) = (pppSexp [text "locals",(pppSexp (map ppp l)),(pppSexp [text "frame-conflict",(pppSexp (map (\(u,l) -> (pppSexp ((ppp u) : (map ppp l)))) l2)),(ppp t)])])
